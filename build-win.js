...
async function main() {
  ...
  try {
    ...
    console.log('✔ All Windows installers created successfully!');
    ...
    const assetPaths = [
      '"' + path.join(__dirname, `dist/OOTP Uniform Maker_${version}_Windows_setup.exe`) +'"',
      '"' + path.join(__dirname, `dist/OOTP Uniform Maker_${version}_Windows_portable.exe`) +'"'
    ];
